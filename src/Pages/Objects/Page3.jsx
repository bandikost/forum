    ...
    <p>Характеристики</p>
      <div className="li-styles" dangerouslySetInnerHTML={{__html: convertIdentifiersToTags(objects3?.character1),}}/>
        <div className="sale-product-cart__map" >
          ...
          <iframe src="https://yandex.ru/map-widget/v1/?lang=ru_RU&amp;scroll=true&amp;um=constructor%3Ad354cf233bbfd941b7c01c5f2a77ec87854b9c4825113202f1770d9ab6f43abd" frameBorder="0" allowFullScreen={true} width="100%"></iframe>   
          <NumbersContact />      
        </div>
  </div> 
