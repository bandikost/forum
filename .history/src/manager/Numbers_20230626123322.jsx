            ...
            {[1].map((i) => (
              <div key={i}  className="table-numbers" style={{display: "flex",
                ...
                <label style={{ margin: "0px 50px" }}>
                  <div style={{ marginLeft: "20px", display: "flex", justifyContent: "space-between", width: "390px", alignItems: "center" }}>Объект № {i}:<p >{numbers?.[`name${i}`]}</p></div>
                  <textarea
                ...
                <label style={{ margin: "0px 50px" }}>
                  <div style={{ margin: "0px 20px" }}>Номер телефона</div>
                  <textarea
                    className="input-edit"
                    style={{ margin: "20px 10px" }}
                    type="text"
...
={(e) => handleImageUpload(e, i)} 
                    ...
                    {numbers && numbers[`imageUrl${i}`] && (
                      <div style={{display: "contents",
                        margin: "0 auto 0"}}><img src={numbers[`imageUrl${i}`]} alt="property" /></div>
                    )}
                  </div>
                </label>
              </div>
