...
export const Manager = () => {
  ...
  const hardcodedUsers = [
    { username: 'Manager', password: 'qweasd3322' }
  ];
  ...
  <p className={s.edit}>Форма редактирования объектов</p>
    <div className={s.form_edit} >
      ...
      <div className={s.ul} style={{marginTop: "100px"}}> 
        <div className={s.li} >
        <NavLink to="/general-edit-id2">{objects2 && objects2.name1}</NavLink>
        </div>
        <img src={objects2[`imageUrl1`]} width={"115px"} height={"95px"} style={{objectFit: "cover", borderRadius: "5px", padding: " 0 20px"}} />
      </div>
    
      <div className={s.ul} style={{marginTop: "100px"}}> 
        <div className={s.li} >
        <NavLink to="/general-edit-id3">{objects3 && objects3.name1}</NavLink>
        </div>
        <img src={objects3[`imageUrl1`]} width={"115px"} height={"95px"} style={{objectFit: "cover", borderRadius: "5px", padding: " 0 20px"}} />
      </div>
      <div className={s.ul} style={{marginTop: "100px"}}> 
        <div className={s.li} >
        <NavLink to="/general-edit-id4">{objects4 && objects4.name1}</NavLink>
        </div>
        <img src={objects4[`imageUrl1`]} width={"115px"} height={"95px"} style={{objectFit: "cover", borderRadius: "5px", padding: " 0 20px"}} />
      </div>
      <div className={s.ul} style={{marginTop: "100px"}}> 
        <div className={s.li} >
        <NavLink to="/general-edit-id5">{objects5 && objects5.name1}</NavLink>
        </div>
        <img src={objects5[`imageUrl1`]} width={"115px"} height={"95px"} style={{objectFit: "cover", borderRadius: "5px", padding: " 0 20px"}} />
      </div>
      <div className={s.ul} style={{marginTop: "100px"}}> 
        <div className={s.li} >
        <NavLink to="/general-edit-id6">{objects6 && objects6.name1}</NavLink>
        </div>
        <img src={objects6[`imageUrl1`]} width={"115px"} height={"95px"} style={{objectFit: "cover", borderRadius: "5px", padding: " 0 20px"}} />
      </div>
      <div className={s.ul} style={{marginTop: "100px"}}> 
        <div className={s.li} >
        <NavLink to="/numbers">Номера телефонов</NavLink>
        </div>
      </div>
    </div>
  </div>
