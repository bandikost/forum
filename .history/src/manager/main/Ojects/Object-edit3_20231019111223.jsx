    ...
    <>
      ...
      <div style={{ backgroundColor: "#c4d3f6", paddingBottom: "60px" }}>
        ...
        Действует сейчас акция?
                ...
                <label style={{marginTop: "100px"}} htmlFor={`file${i}`}>
...
={(e) => handleImageUpload(e, i)} 
            ...
            <button type="submit" style={{ margin: "0px  auto 0px", cursor: "pointer", padding: "20px", display: "flex", position:"relative", top: "100px", borderRadius: "15px" }}>Сохранить</button>
          </form>
        </div>
