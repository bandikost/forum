          ...
          <div className="image-container">
            ...
            {objects && objects[`imageUrl2`] && (
              <div style={{ display: "contents", margin: "0 auto 0" }}>
                ...
                <label htmlFor={`file3`}>
          <div className="image-container">
            <input id={`file3`} type="file" onChange={(e) => handleImageUpload(e, 2)} />
            <div className="image-now">
              Текущее изображение для объекта карточки 3:{" "}
              <div style={{ fontWeight: "500", fontSize: "20px", marginLeft: "10px" }}> № 3</div>
            </div>{" "}
            {objects && objects[`imageUrl3`] && (
              <div style={{ display: "contents", margin: "0 auto 0" }}>
                <img className="actual-photo" src={objects[`imageUrl3`]} alt="property" />
              </div>
            )}
          </div>
                </label>
