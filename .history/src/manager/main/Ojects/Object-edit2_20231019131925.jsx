...
export const GeneralEdit2 = () => {
  ...
  const [newValues, setNewValues] = useState({
    isVisible2: objects2.isVisible || false,
  });
...
/>
        ...
        Действует сейчас акция?
                ...
                <img style={{position: "relative", top: "10px"}} className={s.discount} src={discount}/>
              </div>
            ))}
            <button type="submit" style={{ margin: "0px  auto 0px", cursor: "pointer", padding: "20px", display: "flex", borderRadius: "10px" }}>Сохранить</button>
          </form>
        </div>
