 ...
 if (user) {
  ...
  <p className={s.edit}>Форма редактирования объектов</p>
    <div className={s.form}>
      ...
      <div className={s.ul} style={{marginTop: "100px"}}> 
        <div className={s.li} >
        <NavLink to="/general-edit-id4">{objects5 && objects5.name5}</NavLink>
        </div>
        <img src={objects5[`imageUrl5`]} width={"115px"} height={"95px"} style={{objectFit: "cover", borderRadius: "5px", padding: " 0 20px"}} />
      </div>
      <div className={s.ul} style={{marginTop: "100px"}}> 
        <div className={s.li} >
      ...
      <div className={s.ul} style={{marginTop: "100px"}}> 
        <div className={s.li} >
        <NavLink to="/numbers">{objects6 && objects6.name6}</NavLink>
        </div>
      </div>
    </div>
  </div>
