    ...
    <p>Характеристики</p>
      <pre className="li-styles" dangerouslySetInnerHTML={{__html: convertIdentifiersToTags(objects5?.character1),}}/>
        <div className="sale-product-cart__map" >
          ...
          <iframe src="https://yandex.ru/map-widget/v1/?lang=ru_RU&amp;scroll=true&amp;um=constructor%3A9d7478830288100763a20db8a89572338772673baaf023637b003c426ad440ff" frameBorder="0" allowFullScreen={true} width="100%" ></iframe>     
          <NumbersContact />      
        </div>
  </div> 
