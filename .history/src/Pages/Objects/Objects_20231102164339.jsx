...
const ObjectsComponent = React.lazy(() => {
  return new Promise(resolve => {
    setTimeout(() => resolve(import("./Objects")), 1500);
  });
});
...
const Object = ({ id, showImage, i, newValues}) => {
...
<img
  ...
  />
    ...
    <Suspense fallback={<div>Loading...</div>}>
            <ObjectsComponent id={id} showImage={showImage} i={i} newValues={newValues} />
          </Suspense>
