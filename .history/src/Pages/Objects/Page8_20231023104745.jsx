  ...
  <div className="container-id" style={{top: "80px", position: "relative"}}>
    <div className="container-left">        
      ...
      <hr style={{margin: "-10px 0 20px 0"}}/>
        <li className="characterPRE">Ленинградская область, Кировский район,<br/> 74 км Мурманского шоссе, вблизи д. Васильково (ближайшая ж/д станция – Жихарево).</li>
        <li className="characterPRE">Общая площадь объекта:
948,6 кв. м.</li>
        <li className="characterPRE">Арендная ставка сроком на 11 месяцев:<br/>
1) Растеневодство, скотоводство, овощеводство - 60 руб. за кв. м./мес. /Га;<br/>
