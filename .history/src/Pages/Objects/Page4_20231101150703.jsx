    ...
    <p>Характеристики</p>
      <pre className="li-styles" dangerouslySetInnerHTML={{__html: convertIdentifiersToTags(objects4?.character1),}}/>
        <div className="sale-product-cart__map" >
          ...
          <iframe src="https://yandex.ru/map-widget/v1/?um=constructor%3A4af471ac8301e08310a6e11b0d9185fa1e6fbeacfc9974571740918de7c44195&amp;source=constructor" width="100%" frameBorder="0"></iframe>     
          <NumbersContact />      
        </div>
  </div> 
