  ...
  <div className="container-id" style={{top: "80px", position: "relative"}}>
    <div className="container-left">        
      ...
      <hr style={{margin: "-10px 0 20px 0"}}/>
        ...
        <div className="" style={{marginTop: "50px", fontWeight: "700"}}>Все варинаты аренды вы можете увидеть <a href="http://xn--47-glcqe5aecpy.xn--p1ai/arenda-zemli/">здесь</a>.</div>
        </div>
