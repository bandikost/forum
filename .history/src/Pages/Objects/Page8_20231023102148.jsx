  ...
  <div className="container-id" style={{top: "80px", position: "relative"}}>
    ...
    <p style={{fontWeight: "700", display: "flex", alignItems: "center", justifyContent: "center"}}>Продажа</p>
        ...
        <hr style={{margin: "10px 0 20px 0", width: "100%"}}/>
          <div className="date-discount">{objects8 && objects8.date1} <br /> </div>
            <div style={{lineHeight: "20px", width: "201px", textAlign: "center"}}>Вы можете приобрести данный объект со скидкой:</div>
            <div className="lastprice">
              <p>{objects8 && objects8.lastprice1} </p>
              <span>{objects8 && objects8.procent1}</span>
            </div>
            <div className="newprice">{objects8 && objects8.newprice1}   <br /></div>
            <div>{objects8 && objects8.dateend1}</div>
        </span>
        
          <pre style={{marginTop: "20px", marginLeft: "-3px"}}>{objects8 && objects8.sale1}</pre> 
      <p style={{fontWeight: "700"}}>Характеристики</p>
      <hr style={{margin: "-10px 0 20px 0"}}/>
        <pre className="characterPRE">{objects8 && objects8.character1}</pre>
        </div>
        <div className="container-right">
          <p>{objects8 && objects8.name1}</p>
            <img src={objects8[`imageUrl1`]} width={"230px"} height={"190px"} style={{ borderRadius: "5px"}} />
            ...
            <iframe src="https://yandex.ru/map-widget/v1/?um=constructor%3Ae4a372c9bc7e4d5e1a71a8dc7538e25fabcff32e8dfca1557013ce417a847b30&amp;source=constructor" width="100%" height="300px"></iframe>            </div>
