  ...
  <div className="container-right">
          ...
          <span> Коммерческое предложение в pdf:<a href="ids/Екатериновка.pdf" download>Скачать PDF</a></span>
            <div className="sale-product-cart__map" >
              <iframe src="https://yandex.ru/map-widget/v1/?lang=ru_RU&amp;scroll=true&amp;um=constructor%3Aada49d178fdc1702cf078af39ad78cbcf8d6413d622c32a308f7b1b0dac3e02e" frameBorder="0" allowFullScreen={true} width="100%" height="300px" ></iframe>            </div>
              <NumbersContact />
            </div>
    <div className="container-left">
      <b className="sale">Продажа</b>
       <span className="discount">
          { /* <hr style={{margin: "10px 0 20px 0", width: "90%", backgroundColor: "red", height: "2px", border: "none"}}/> */}
          <div className="date-discount">{objects && objects.date1} <br /> </div>
            <div className="ucan">Вы можете приобрести данный объект со скидкой:</div>
            <div className="lastprice">
              <p>{objects && objects.lastprice1} </p>
              <span>{objects && objects.procent1}</span>
            </div>
            <div className="newprice">{objects && objects.newprice1}   <br /></div>
