  ...
  <div className="container-id" style={{top: "80px", position: "relative"}}>
    <div className="container-left">        
      ...
      <hr style={{margin: "-10px 0 20px 0"}}/>
        <li className="characterPRE">Площадь земель от 5га до 100га (и выше) </li>
...
74 км Мурманского шоссе.</li>
        <div className="" style={{marginTop: "50px", fontWeight: "700"}}>Ознакомится с вариантами и условиями аренды можно
        ...
        <div className="numbers"  style={{position: "relative", left: "-207px", top: "20px"}}>
                <h3 className="h3 h3__sale">За более подробной информацией обращайтесь к 
нашим менеджерам по телефону:<h3 className="h3 h3__sale"><a href="">{numbers && numbers.name2}</a></h3></h3>
