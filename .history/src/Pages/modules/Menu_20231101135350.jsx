...
return (
 ...
 <ul className={s.navigation}>
        ...
        <li className={s.items}>
          <NavLink style={{width: "170px", display: "flex"}} to="/" className={`${s.link} ${isActive('/') ? s.active : s.inactive}`}>
            02. Изображение
          </NavLink>
        </li>
        <li className={s.items}>
          <NavLink style={{width: "170px", display: "flex"}} to="/object" className={`${s.link} ${isActive('/object') ? s.active : s.inactive}`}>
            03. Описание
          </NavLink>
        </li>
        <li className={s.items}>
