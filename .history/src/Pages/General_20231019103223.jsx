...
//Импорт серий из базы данных
  ...
  const [isVisible, setIsVisible] = useState(() => {
    ...
    return storedIsVisible ? JSON.parse(storedIsVisible) : showImage;
  });
...
if (!objectId) {
  ...
  return (
    <div className={s.s}>
        ...
        src={showImage && newValues.isVisible ? objects3[`imageUrl${i}`] : sold}
        width={"230px"}
        height={"190px"}
        style={{
          borderRadius: "5px",
          display: showImage && newValues.isVisible ? "block" : "none",
        }}
      />
