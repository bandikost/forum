    ...
    <div>
        ...
        <div className={s.container} style={{paddingBottom: "50px"}}> 
          ...
          <div className={s.map} >
            ...
            <p className={s.suptitle} style={{margin: "60px 0px"}}>Более подробную информацию по аренде земельных участков и строений<br />на Мурманском шоссе можно получить по телефону: <span style={{color: "blue"}}>{numbers && numbers.name1}</span>  и по электронной почте <span style={{color: "blue"}}>206@fgr.ru</span></p>
