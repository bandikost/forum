  ...
  return (
    <div>
        ...
        <div className={s.container} style={{paddingBottom: "50px"}}>
            ...
            <p>Основной актив нашей компании – это команда профессионалов и единомышленников.</p><br />
            <p>Приобретение недвижимости для многих людей является серьезным шагом к достижению целей.</p><br />
            <p>Мы помогаем приблизить вашу цель, предлагая объекты недвижимости различного назначения с наиболее выгодными условиями, и квалифицированной поддержкой менеджеров и юристов.</p></div>
