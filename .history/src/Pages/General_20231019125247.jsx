...
const initialObjects = Array.from({ length: 6 }, () => useState({}));
const objectsState = Object.fromEntries(initialObjects.map((state, index) => [`objects${index + 1}`, state]));

const { objects1, objects2, objects3, objects4, objects5, objects6 } = objectsState;
