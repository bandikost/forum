    ...
    <div>
        ...
        <div className={s.container} style={{paddingBottom: "50px"}}> 
          ...
          <div className={s.map} >
            ...
            <p className={s.suptitle} style={{margin: "60px 0px"}}>Более подробную информацию по аренде земельных участков и строений на Мурманском шоссе <br />  
            можно получить по телефону:<div>{numbers && numbers.name1} </div> и по электронной почте <div>206@fgr.ru</div></p>
