    ...
    <div>
        ...
        <div className={s.container} style={{paddingBottom: "50px"}}> 
          ...
          <div className={s.map} >
            ...
            <div className={s.suptitle} style={{margin: "60px 0px"}}>
              Более подробную информацию по аренде земельных участков и строений<br/>   на Мурманском шоссе
              можно получить по телефону:<p>{numbers && numbers.name1}</p>и по электронной почте <p>206@fgr.ru</p> 
            </div>        
        </div>
  )
}
