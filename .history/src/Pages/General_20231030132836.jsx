...
<div className={s.container}><img src={Banner} alt="" className={s.Banner}  height={"330px"} width={"100%"} /></div>
...
<img
  ...
  />
    ...
    <hr style={{width: "55%", marginTop: "50px"}} />
        ...
        <div className={s.numbers}>
          <div className={s.numbers_container}>
            ...
            <div className={s.the_number}>Отдел продаж:
              <span style={{fontWeight: "600", margin: "0 0 0 20px"}}>{numbers && numbers.name2}</span></div>
            <div className={s.the_number}>Отдел aренды:
              <span style={{fontWeight: "600", margin: "0 0 0 20px"}}>{numbers && numbers.name1}</span>
            </div>
          </div>
        </div>
        <div className={s.numbers}>
          <div className={s.the_address}>в</div>
          <div className={s.the_address}>г</div>
        </div>
        <div className={s.numbers}>
          <div className={s.the_year}>д</div>
          <div className={s.the_year}>у</div>
        </div>
      </div>
</div>
