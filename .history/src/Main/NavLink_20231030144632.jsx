  ...
  <>
   ...
   <ul className={s.navigation}>                                             
            <li className={s.items}>
              <NavLink to="/general" className={({ isActive }) => isActive ? s.active : ""}>01. на главную</NavLink>
            </li>     
            <li className={s.items}>
                    <NavLink to="/about" className={({ isActive }) => isActive ? s.active : ""}>02. о нас </NavLink>
            </li>
            <li className={s.items}>
                    <NavLink to="/contacts" className={({ isActive }) => isActive ? s.active : ""}>03. контакты </NavLink>
            </li>
            </ul>
  {isMobile && (
