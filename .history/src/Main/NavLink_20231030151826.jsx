...
return (
  <>
   ...
   <li className={s.items}>
                    <NavLink to="/about" className={({ isActive }) => isActive ? s.active : ""}>01. о нас </NavLink>
            </li>                                         
            <li className={s.items}>
            <NavLink to="/general" className={s.items} activeClassName={s.active}> 02. главная</NavLink>
            </li>    
            <li className={s.items}>
              <NavLink to="/object" className={({ isActive }) => isActive ? s.active : ""}>03. объекты</NavLink>
            </li>   
            <li className={s.items}>
